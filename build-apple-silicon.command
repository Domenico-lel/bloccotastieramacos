...
compiled_executable="$build_dir/Blocco-Tastiera-arm64.compiled"
...
ditto -c -k --keepParent "$app_path" "$build_dir/Blocco-Tastiera-Apple-Silicon.zip"

print ""
print "Creata: $app_path"
print "Archivio: $build_dir/Blocco-Tastiera-Apple-Silicon.zip"
